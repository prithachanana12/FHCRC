...
df_pca_data <- data.frame(PC1=pca_data$x[,1], PC2=pca_data$x[,2], sample=colnames(dat), condition=c("ctrl","sifzd2","tgfb","comb","sifzd2","tgfb","comb","ctrl","sifzd2","tgfb","comb","ctrl"))
head(df_pca_data)
